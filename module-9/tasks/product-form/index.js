...
export default class ProductFormComponent {
  ...
  render () {
    ...
    this.sortableList.element.setAttribute("data-elem", "imageListContainer");
    this.subElements.imageListContainer.replaceWith(this.sortableList.element);
    this.subElements.imageListContainer = this.sortableList.element;
